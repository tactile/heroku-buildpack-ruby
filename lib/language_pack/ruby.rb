...
ERROR
  ...
  def install_sqlite3
     ...
     run("bundle config build.sqlite3 --with-sqlite3-dir=`pwd`/vendor/sqlite --with-sqlite3-include=`pwd`/vendor/sqlite/include --with-sqlite3-lib=`pwd`/vendor/sqlite/lib")
  end
