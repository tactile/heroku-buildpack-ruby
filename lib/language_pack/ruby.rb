  ...
  def build_bundler
    log("bundle") do
      ...
      Dir.mktmpdir("libyaml-") do |tmpdir|
        ...
        env_vars       = "env BUNDLE_GEMFILE=#{pwd}/Gemfile BUNDLE_CONFIG=#{pwd}/.bundle/config CPATH=#{yaml_include}:$CPATH CPPATH=#{yaml_include}:$CPPATH:#{File.expand_path("vendor/sqlite/include")} LIBRARY_PATH=#{yaml_lib}:#{File.expand_path("vendor/sqlite/lib")}:$LIBRARY_PATH RUBYOPT=\"#{syck_hack}\""
